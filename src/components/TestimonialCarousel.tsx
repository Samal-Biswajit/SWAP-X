  ...
  return (
    <div className="w-full flex justify-center px-4">
      <div className="w-full max-w-3xl">
        <div className="card text-center relative overflow-hidden mx-auto w-full">
          {/* Quote mark background */}
          <div className="absolute top-4 left-8 text-8xl font-black text-accent/5">
            &ldquo;
          </div>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    i === current ? "bg-accent w-6" : "bg-muted w-2"
                  }`}
